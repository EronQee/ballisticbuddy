...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('en', 'pt', 'ar', 'es', 'fr', 'ru');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('en', 'pt', 'ar', 'es', 'fr', 'ru');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('en', 'pt', 'ar', 'es', 'fr', 'ru');
