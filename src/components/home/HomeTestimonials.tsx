...
const TESTIMONIALS_DATA = [
  {
    ...
    label: 'Question 1',
    author: 'PRICE',
    company: 'Transparent ranges, no surprises',
    quote:
      'What does it actually cost? We publish realistic price ranges for every protection level — and every price page carries a clear caveat. Get a firm quote at /cost.',
    initials: 'PR',
  },
  {
    id: 'quote-2',
    label: 'Question 2',
    author: 'PROOF',
    company: 'Tested to GA/T, reproducible',
    quote:
      'Can you prove the protection? Every claim ships with a test protocol you can reproduce. Buy the sample, run the test, verify the number yourself.',
    initials: 'PF',
  },
  {
    id: 'quote-3',
    label: 'Question 3',
    author: 'VERIFY',
    company: 'Sample-first buying',
    quote:
      "Don't take our word for it. Take the sample. Request one, test it, and only then move to a full order — the panel either performs or it doesn't.",
    initials: 'VF',
  },
]
    ...
    <div id="testimonials" className="testimonials">
      ...
      <div className="testimonials__header">
        <div className="testimonials__header-item">
          <h2 className="eyebrow">The three questions every buyer asks</h2>
        </div>

        <div className="testimonials__header-item">
          <h3 className="display-lg">
            PRICE, PROOF, VERIFICATION — ANSWERED UP FRONT
          </h3>
        </div>

        <div className="testimonials__header-sub">
          <p className="text-body">
            Ballistic glass and run-flat tires are a considered purchase. We answer the doubts
            directly — with transparent ranges, reproducible test protocols, and a sample-first
            buying path.
          </p>
        </div>
      </div>
